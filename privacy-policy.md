...
Questa pagina raccoglie alcuni dati personali dei propri utenti. Titolare del trattamento dei dati: ASD Club Sub Nettuno via dello Sport 6, Bologna – p.IVA: 2665601205 Indirizzo email del titolare: {{ site.contactus_email }}
...
## Privacy policy: base giuridica del trattamento {#toc_4}
...
### Accesso all’account Linkedin (Linkedin) {#toc_12}
...
### Google Fonts (Google Inc.) {#toc_19}
...
### Come esercitare i diritti {#toc_22}
